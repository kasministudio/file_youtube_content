...
#define API_KEY "API KEY YOUTUBE API" //Your Youtube API-Key 
#define CHANNEL_ID "CHANNEL ID" // Your youtube channel ID. 

String userName = "IG Account"; // Your Instagram Username
